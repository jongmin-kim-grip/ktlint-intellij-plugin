...
dependencies {
    api("com.pinterest.ktlint:ktlint-core:0.48.1") {
        exclude("org.slf4j")
    }
    implementation("com.pinterest.ktlint:ktlint-ruleset-standard:0.48.1") {
        exclude("org.slf4j")
    }
    implementation("com.pinterest.ktlint:ktlint-ruleset-experimental:0.48.1") {
        exclude("org.slf4j")
    }
}
